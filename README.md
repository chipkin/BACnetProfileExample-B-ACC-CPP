...
Verified live with a real `bacpypes3` client, not just a local process check:
...
These numbers were measured from a **STATIC**-library build; the next release
refreshes them under the SOURCE-mode build documented above.
